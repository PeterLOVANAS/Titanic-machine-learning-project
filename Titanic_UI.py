...
def run_model():
    ...
    if ch == "Model V5":
        ...
        result_et.insert("", predict_state(predictions))
...
lab_result = Label(text = "This person has a chance to",font=("Times", 15, "roman"))
lab_result.place(x = 260 , y = 430)
lab_result2 = Label(text = "in this trip",font=("Times", 15, "roman"))
